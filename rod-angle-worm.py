...
#calculate the included angle between rod and axis of the worm-like micelle
nvx,nvy,nvz = 0,1,0
for i in range(nmol):
    ...
    cosab = axb/(a*b)
    angle = numpy.arccos(abs(cosab))*180.0/numpy.pi
    print >> fout, coms[i][1],coms[i][2],angle
    print >> fcurve, coms[i][2], cosab
